...
function iniciarContactos() {
	...
	setTimeout(function() {
	    ...
	    if ($("#tabContactos").data("bootstrap.table")) {
...
function iniciarDocumentos() {
    ...
    if ($("#tabDocumentos").data("bootstrap.table")) {
...
function iniciarInteracciones() {
    ...
    if ($("#tabInteracciones").data("bootstrap.table")) {
...
function iniciarRecordatorios() {
    ...
    if ($("#tabRecordatorios").data("bootstrap.table")) {
