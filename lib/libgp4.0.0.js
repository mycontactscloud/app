...
function modal1(t, m, i) {
    ...
    h +=    '               <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>';
    h +=    '          </div>';
...
function crearToastDocumento(t, m, o) {
    ...
    h +=    '               <button type="button" class="btn-close btn-sm" data-bs-dismiss="toast" aria-label="Cerrar" title="Cerrar" data-bs-toggle="tooltip"></button>';
    h +=    '              </div>';
    h +=    '          </div>';
    h +=    '      </div>';
    h +=    '</div>';
            ...
            <div class="modal-dialog modal-md">
                <div class="modal-content rounded-4 shadow">
                    <div class="modal-header bg-light sticky-top">
                        ...
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar" onclick="saveColumnConfig('${idTabla}')"></button>
                    </div>
...
function modMsjFinPruebaToast(n, t, m, o) {
    ...
    h +=    '       <button type="button" class="btn-close" id="close-toast" aria-label="Cerrar"></button>'; // Botón de cierre manual
    h +=    '   </div>';
    h +=    '   <div class="toast-body">';
