...
function traducirAtributosIdioma(raiz, idPa) {
    ...
    const tooltips = raiz.querySelectorAll('[data-bs-toggle="tooltip"]');
    tooltips.forEach((tooltip) => {
        ...
        const instancia = bootstrap.Tooltip.getInstance(tooltip);
...
function mccFormatoBytes(bytes) {
    ...
    if (valor < 1000000) return formato(valor / 1000, 1) + ' KB';
    if (valor < 1000000000) return formato(valor / 1000000, 1) + ' MB';
    return formato(valor / 1000000000, 2) + ' GB';
}
