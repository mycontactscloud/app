...
function libIdioma(id, n) {
	...
	var nomFichero = 'https://cdn.jsdelivr.net/gh/mycontactscloud/app@main/lib/idio4/mcc_' + id + '.js?v=4.0.0-26';
...
async function mccCargarIdiomaSummernoteContactos() {
    if (mccIdiomaSummernoteContactos() !== 'pt-BR') return true;
    const url = new URL('lib/summernote/lang/summernote-pt-BR.min.js', document.baseURI);
