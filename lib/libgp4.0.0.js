...
function iniciarEventos() {
    ...
    calendar = new FullCalendar.Calendar(calendarEl, {
		...
		noEventsContent: String(idLocale || '').toLowerCase().startsWith('de')
			...
			: (String(idLocale || '').toLowerCase().startsWith('ca') ? 'No hi ha cap esdeveniment' : undefined),
...
function libIdioma(id, n) {
	if (libIdioCargado == id) {
	    ...
	    var nomFichero    	= 'https://cdn.jsdelivr.net/gh/mycontactscloud/app/lib/idio4/mcc_' + id + '.js?v=4.0.0-16';
